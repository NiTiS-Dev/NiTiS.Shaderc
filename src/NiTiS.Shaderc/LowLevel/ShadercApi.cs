...
public static unsafe partial class ShadercApi
{
    ...
    [DllImport("shaderc", CallingConvention = CallingConvention.Cdecl, EntryPoint = "shaderc_compiler_initialize", ExactSpelling = true)]
    ...
    [DllImport("shaderc", CallingConvention = CallingConvention.Cdecl, EntryPoint = "shaderc_compiler_release", ExactSpelling = true)]
    ...
    [DllImport("shaderc", CallingConvention = CallingConvention.Cdecl, EntryPoint = "shaderc_compile_options_initialize", ExactSpelling = true)]
    ...
    [DllImport("shaderc", CallingConvention = CallingConvention.Cdecl, EntryPoint = "shaderc_compile_options_clone", ExactSpelling = true)]
    [return: NativeTypeName("shaderc_compile_options_t")]
    ...
    [DllImport("shaderc", CallingConvention = CallingConvention.Cdecl, EntryPoint = "shaderc_compile_options_release", ExactSpelling = true)]
    ...
    [DllImport("shaderc", CallingConvention = CallingConvention.Cdecl, EntryPoint = "shaderc_compile_options_add_macro_definition", ExactSpelling = true)]
    ...
    [DllImport("shaderc", CallingConvention = CallingConvention.Cdecl, EntryPoint = "shaderc_compile_options_set_source_language", ExactSpelling = true)]
    ...
    [DllImport("shaderc", CallingConvention = CallingConvention.Cdecl, EntryPoint = "shaderc_compile_options_set_generate_debug_info", ExactSpelling = true)]
    ...
    [DllImport("shaderc", CallingConvention = CallingConvention.Cdecl, EntryPoint = "shaderc_compile_options_set_optimization_level", ExactSpelling = true)]
    ...
    [DllImport("shaderc", CallingConvention = CallingConvention.Cdecl, EntryPoint = "shaderc_compile_options_set_forced_version_profile", ExactSpelling = true)]
    ...
    [DllImport("shaderc", CallingConvention = CallingConvention.Cdecl, EntryPoint = "shaderc_compile_options_set_include_callbacks", ExactSpelling = true)]
    ...
    [DllImport("shaderc", CallingConvention = CallingConvention.Cdecl, EntryPoint = "shaderc_compile_options_set_suppress_warnings", ExactSpelling = true)]
    ...
    [DllImport("shaderc", CallingConvention = CallingConvention.Cdecl, EntryPoint = "shaderc_compile_options_set_target_env", ExactSpelling = true)]
    ...
    [DllImport("shaderc", CallingConvention = CallingConvention.Cdecl, EntryPoint = "shaderc_compile_options_set_target_spirv", ExactSpelling = true)]
    ...
    [DllImport("shaderc", CallingConvention = CallingConvention.Cdecl, EntryPoint = "shaderc_compile_options_set_warnings_as_errors", ExactSpelling = true)]
    ...
    [DllImport("shaderc", CallingConvention = CallingConvention.Cdecl, EntryPoint = "shaderc_compile_options_set_limit", ExactSpelling = true)]
    ...
    [DllImport("shaderc", CallingConvention = CallingConvention.Cdecl, EntryPoint = "shaderc_compile_options_set_auto_bind_uniforms", ExactSpelling = true)]
    ...
    [DllImport("shaderc", CallingConvention = CallingConvention.Cdecl, EntryPoint = "shaderc_compile_options_set_auto_combined_image_sampler", ExactSpelling = true)]
    ...
    [DllImport("shaderc", CallingConvention = CallingConvention.Cdecl, EntryPoint = "shaderc_compile_options_set_hlsl_io_mapping", ExactSpelling = true)]
    ...
    [DllImport("shaderc", CallingConvention = CallingConvention.Cdecl, EntryPoint = "shaderc_compile_options_set_hlsl_offsets", ExactSpelling = true)]
    ...
    [DllImport("shaderc", CallingConvention = CallingConvention.Cdecl, EntryPoint = "shaderc_compile_options_set_binding_base", ExactSpelling = true)]
    ...
    [DllImport("shaderc", CallingConvention = CallingConvention.Cdecl, EntryPoint = "shaderc_compile_options_set_binding_base_for_stage", ExactSpelling = true)]
    ...
    [DllImport("shaderc", CallingConvention = CallingConvention.Cdecl, EntryPoint = "shaderc_compile_options_set_preserve_bindings", ExactSpelling = true)]
    ...
    [DllImport("shaderc", CallingConvention = CallingConvention.Cdecl, EntryPoint = "shaderc_compile_options_set_auto_map_locations", ExactSpelling = true)]
    ...
    [DllImport("shaderc", CallingConvention = CallingConvention.Cdecl, EntryPoint = "shaderc_compile_options_set_hlsl_register_set_and_binding_for_stage", ExactSpelling = true)]
    ...
    [DllImport("shaderc", CallingConvention = CallingConvention.Cdecl, EntryPoint = "shaderc_compile_options_set_hlsl_register_set_and_binding", ExactSpelling = true)]
    ...
    [DllImport("shaderc", CallingConvention = CallingConvention.Cdecl, EntryPoint = "shaderc_compile_options_set_hlsl_functionality1", ExactSpelling = true)]
    ...
    [DllImport("shaderc", CallingConvention = CallingConvention.Cdecl, EntryPoint = "shaderc_compile_options_set_hlsl_16bit_types", ExactSpelling = true)]
    ...
    [DllImport("shaderc", CallingConvention = CallingConvention.Cdecl, EntryPoint = "shaderc_compile_options_set_vulkan_rules_relaxed", ExactSpelling = true)]
    ...
    [DllImport("shaderc", CallingConvention = CallingConvention.Cdecl, EntryPoint = "shaderc_compile_options_set_invert_y", ExactSpelling = true)]
    ...
    [DllImport("shaderc", CallingConvention = CallingConvention.Cdecl, EntryPoint = "shaderc_compile_options_set_nan_clamp", ExactSpelling = true)]
    ...
    [DllImport("shaderc", CallingConvention = CallingConvention.Cdecl, EntryPoint = "shaderc_compile_into_spv", ExactSpelling = true)]
    ...
    [DllImport("shaderc", CallingConvention = CallingConvention.Cdecl, EntryPoint = "shaderc_compile_into_spv_assembly", ExactSpelling = true)]
    [return: NativeTypeName("shaderc_compilation_result_t")]
    ...
    [DllImport("shaderc", CallingConvention = CallingConvention.Cdecl, EntryPoint = "shaderc_compile_into_preprocessed_text", ExactSpelling = true)]
    [return: NativeTypeName("shaderc_compilation_result_t")]
    ...
    [DllImport("shaderc", CallingConvention = CallingConvention.Cdecl, EntryPoint = "shaderc_assemble_into_spv", ExactSpelling = true)]
    [return: NativeTypeName("shaderc_compilation_result_t")]
    ...
    [DllImport("shaderc", CallingConvention = CallingConvention.Cdecl, EntryPoint = "shaderc_result_release", ExactSpelling = true)]
    ...
    [DllImport("shaderc", CallingConvention = CallingConvention.Cdecl, EntryPoint = "shaderc_result_get_length", ExactSpelling = true)]
    ...
    [DllImport("shaderc", CallingConvention = CallingConvention.Cdecl, EntryPoint = "shaderc_result_get_num_warnings", ExactSpelling = true)]
    [return: NativeTypeName("size_t")]
    ...
    [DllImport("shaderc", CallingConvention = CallingConvention.Cdecl, EntryPoint = "shaderc_result_get_num_errors", ExactSpelling = true)]
    [return: NativeTypeName("size_t")]
    ...
    [DllImport("shaderc", CallingConvention = CallingConvention.Cdecl, EntryPoint = "shaderc_result_get_compilation_status", ExactSpelling = true)]
    ...
    [DllImport("shaderc", CallingConvention = CallingConvention.Cdecl, EntryPoint = "shaderc_result_get_bytes", ExactSpelling = true)]
    ...
    [DllImport("shaderc", CallingConvention = CallingConvention.Cdecl, EntryPoint = "shaderc_result_get_error_message", ExactSpelling = true)]
    [return: NativeTypeName("const char *")]
    ...
    [DllImport("shaderc", CallingConvention = CallingConvention.Cdecl, EntryPoint = "shaderc_get_spv_version", ExactSpelling = true)]
    ...
    [DllImport("shaderc", CallingConvention = CallingConvention.Cdecl, EntryPoint = "shaderc_parse_version_profile", ExactSpelling = true)]
